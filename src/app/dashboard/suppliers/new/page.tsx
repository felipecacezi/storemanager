...
export default function NewSupplierPage() {
  ...
  const onSubmit = (values: z.infer<typeof SupplierSchema>) => {
    startTransition(async () => {
      // Aqui você adicionaria a lógica para salvar o fornecedor no banco de dados.
  ...
  return (
    <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        ...
        <CardHeader>
            ...
            <CardDescription>
            Preencha os detalhes abaixo para adicionar um novo fornecedor.
            </CardDescription>
        </CardHeader>
        <CardContent>
            <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <FormField
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input 
                            placeholder="Avenida Principal, 456 - Belo Horizonte, MG" 
                            {...field} 
                            disabled={isPending}
                            />
                        </FormControl>
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <Button type="submit" disabled={isPending}>
                        {isPending ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Salvar Fornecedor"}
                    </Button>
                </div>
            </form>
            </Form>
